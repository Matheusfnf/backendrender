...
const index_1 = __importDefault(require("../../repositories/session-repository/index"));
const index_2 = __importDefault(require("../../repositories/user-repository/index"));
...
async function getUserOrFail(email) {
    const user = await index_2.default.findByEmail(email, {
        id: true,
        email: true,
        password: true,
    });
